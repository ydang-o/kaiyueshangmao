...
extends TreeNode {
    ...
    public String toString() {
        return "GoodsCategoryTree(enable=" + this.getEnable() + ", parentId=" + this.getParentId() + ", name=" + this.getName() + ", description=" + this.getDescription() + ", picUrl=" + this.getPicUrl() + ", sort=" + this.getSort() + ", createTime=" + String.valueOf(this.getCreateTime()) + ", updateTime=" + String.valueOf(this.getUpdateTime()) + ", delFlag=" + this.getDelFlag() + ")";
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GoodsCategoryTree)) {
            return false;
        }
        GoodsCategoryTree other = (GoodsCategoryTree)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GoodsCategoryTree;
    }
