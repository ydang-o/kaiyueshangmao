...
implements Filter {
        ...
        try {
            ...
            if (code == 60001 || code == 60002) {
                ...
                if (log.isDebugEnabled()) {
                    log.debug("[WxMa] 60001/60002 response path={} code={} token present={}", path, code, StringUtils.isNotEmpty(req.getHeader("X-Wx-Token")));
                }
                return;
            }
        }
    ...
    private static String buildDetailMsg(int code, String originalMsg, String path) {
        String base = StringUtils.isNotEmpty(originalMsg) ? originalMsg : (code == 60002 ? "\u8bf7\u643a\u5e26\u767b\u5f55\u4ee4\u724c" : "\u767b\u5f55\u5df2\u8fc7\u671f\uff0c\u8bf7\u91cd\u65b0\u767b\u5f55");
