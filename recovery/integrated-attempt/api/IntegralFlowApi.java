...
public class IntegralFlowApi {
    ...
    private UmsMember getCurrentMember() {
        ...
        try {
            ...
            UmsMember member2 = (UmsMember)this.umsMemberService.getById(memberId);
            if (member2 != null) {
    ...
    public AjaxResult exchange(@RequestBody IntegralExchangeDTO dto) {
        ...
        if (needPoints == null || needPoints <= 0) {
            if (goods.getIntegralPrice() != null && goods.getIntegralPrice() > 0) {
                ...
                return AjaxResult.error("\u8be5\u5546\u54c1\u4e0d\u652f\u6301\u79ef\u5206\u5151\u6362");
            }
        }
        ...
        if (StringUtils.isBlank(phone) || phone.startsWith("999")) {
        ...
        this.integralFlowService.addPoints(member.getId(), -needPoints.intValue(), 1, remarkPrefix + goodsName + orderNoSuffix);
        ...
        return AjaxResult.success("\u5151\u6362\u6210\u529f", data);
    }
    ...
    public AjaxResult list(@RequestParam(defaultValue="1") Integer page, @RequestParam(defaultValue="20") Integer pageSize) {
        ...
        Page pageParam = new Page(page.intValue(), pageSize.intValue());
        Page result = ((LambdaQueryChainWrapper)((LambdaQueryChainWrapper)this.integralFlowService.lambdaQuery().eq(TbIntegralFlow::getUserId, member.getId())).orderByDesc(TbIntegralFlow::getOperTime)).page(pageParam);
        HashMap<String, Object> data = new HashMap<String, Object>();
    ...
    public AjaxResult grant(@RequestBody Map<String, Object> body) {
        ...
        block37: {
            ...
            if (pointsObj instanceof Number) {
                ...
                try {
                    ...
                    return AjaxResult.error("\u79ef\u5206\u6570\u91cf\u683c\u5f0f\u9519\u8bef");
                }
            }
            ...
            if (StringUtils.isNotEmpty(userIdStr)) {
                ...
                try {
                    ...
                    if (sysUser2 != null && StringUtils.isNotEmpty(sysUser2.getPhonenumber()) && (member = this.umsMemberService.getByPhone(sysUser2.getPhonenumber())) != null) {
                        isAdminGrant = true;
                    }
                    if (member == null) {
                        return AjaxResult.error("\u672a\u627e\u5230\u8be5\u7528\u6237\u5bf9\u5e94\u7684\u4f1a\u5458\u4fe1\u606f\uff0c\u8bf7\u786e\u4fdd\u7528\u6237\u5df2\u7ed1\u5b9a\u624b\u673a\u53f7");
                    }
                }
                catch (NumberFormatException e) {
            ...
            if (member == null) {
                return AjaxResult.error("\u672a\u627e\u5230\u4f1a\u5458\u4fe1\u606f\uff0c\u8bf7\u63d0\u4f9b\u6709\u6548\u7684\u7528\u6237ID\u6216\u4f1a\u5458\u7801");
            }
            dealerMemberId = null;
            try {
        ...
        try {
            if (dealerMemberId != null && (currentUser = this.sysUserService.selectUserById(dealerMemberId)) != null) {
                String string = operatorName = StringUtils.isNotEmpty(currentUser.getNickName()) ? currentUser.getNickName() : currentUser.getUserName();
                if (currentUser.getDealerLevel() != null && currentUser.getDealerLevel() > 0 && !currentUser.isAdmin()) {
                    ...
                    if (dealer != null && StringUtils.isNotEmpty(dealer.getNickname())) {
        ...
        if (currentUser != null && !currentUser.isAdmin()) {
            ...
            if (dealerMember.getPoints() == null || dealerMember.getPoints() < points) {
                return AjaxResult.error("\u79ef\u5206\u4f59\u989d\u4e0d\u8db3\uff0c\u5f53\u524d\u4f59\u989d\uff1a" + (dealerMember.getPoints() != null ? dealerMember.getPoints() : 0) + "\uff0c\u9700\u8981\u53d1\u653e\uff1a" + points);
            }
            this.integralFlowService.addPoints(dealerMember.getId(), -points.intValue(), 2, "\u53d1\u653e\u79ef\u5206\u7ed9\u4f1a\u5458[" + member.getNickname() + "]");
        }
        Object finalRemark = StringUtils.isNotEmpty(remark) ? remark : "[" + operatorName + "]\u53d1\u653e\u79ef\u5206";
        log.info("[\u7ba1\u7406\u7aef\u53d1\u653e\u79ef\u5206] \u5f00\u59cb: \u64cd\u4f5c\u4eba={}, \u4f1a\u5458ID={}, \u79ef\u5206={}", operatorName, member.getId(), points);
