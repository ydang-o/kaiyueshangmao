 ...
 *  com.dingyangmall.mall.config.MallConfigProperties
 ...
 *  com.dingyangmall.mall.service.Kuaidi100QueryService
 ...
 *  com.dingyangmall.weixin.config.WxPayConfiguration
 *  com.dingyangmall.weixin.constant.MyReturnCode
 *  com.dingyangmall.weixin.entity.WxUser
 *  com.dingyangmall.weixin.utils.LocalDateTimeUtils
 *  com.dingyangmall.weixin.utils.WxMaUtil
...
public class OrderInfoApi {
    ...
    public AjaxResult getOrderInfoPage(Page page, OrderInfo orderInfo) {
        ...
        if (!userIdInfo.hasPhone) {
            return AjaxResult.error((int)400, (String)"\u8bf7\u5148\u7ed1\u5b9a\u624b\u673a\u53f7");
        }
        orderInfo.setUserIdList(userIdInfo.userIdList);
        return AjaxResult.success((Object)this.orderInfoService.page2((IPage)page, orderInfo));
    }
        ...
        block5: {
            ...
            try {
                ...
                if (member != null) {
                    ...
                    if (StringUtils.isNotBlank((CharSequence)member.getPhone()) && !member.getPhone().startsWith("999")) {
                        info.userIdList.add(member.getPhone());
                        info.hasPhone = true;
                    }
                    if (StringUtils.isNotBlank((CharSequence)member.getMemberCode()) && !member.getMemberCode().startsWith("oAw")) {
                ...
                WxMaUser wxUser;
                info.userIdList.add(memberIdStr);
                if (this.wxMaUserMapper == null || (wxUser = this.wxMaUserMapper.selectByOpenid(memberIdStr)) == null || !StringUtils.isNotBlank((CharSequence)wxUser.getPhone())) break block5;
    ...
    private String getCurrentUserPhone() {
        ...
        try {
            Long memberId = Long.parseLong(memberIdStr);
            UmsMember member = (UmsMember)this.umsMemberService.getById((Serializable)memberId);
            if (member != null && StringUtils.isNotBlank((CharSequence)member.getPhone()) && !member.getPhone().startsWith("999")) {
        ...
        if (this.wxMaUserMapper != null && (wxUser = this.wxMaUserMapper.selectByOpenid(memberIdStr)) != null && StringUtils.isNotBlank((CharSequence)wxUser.getPhone())) {
    ...
    public AjaxResult getById(@PathVariable(value="id") String id) {
        return AjaxResult.success((Object)this.orderInfoService.getById2((Serializable)((Object)id)));
    }
    ...
    public AjaxResult save(@RequestBody PlaceOrderDTO placeOrderDTO) {
        ...
        List skus = placeOrderDTO.getSkus();
        if (skus != null && !skus.isEmpty() && (goods = (GoodsSpu)this.goodsSpuService.getById((Serializable)((Object)(spuId = ((PlaceOrderGoodsDTO)skus.get(0)).getSpuId())))) != null && goods.getIntegralPrice() != null && goods.getIntegralPrice() > 0) {
            isIntegralOrder = true;
            needPoints = goods.getIntegralPrice() * ((PlaceOrderGoodsDTO)skus.get(0)).getQuantity();
        }
        if (isIntegralOrder) {
            UmsMember member = (UmsMember)this.umsMemberService.getById((Serializable)Long.valueOf(Long.parseLong(memberId)));
            if (member == null) {
            ...
            if (StringUtils.isBlank((CharSequence)placeOrderDTO.getUserAddressId())) {
        ...
        if (orderInfo == null) {
            return AjaxResult.error((int)MyReturnCode.ERR_70003.getCode(), (String)MyReturnCode.ERR_70003.getMsg());
        }
        if (isIntegralOrder) {
            this.integralFlowService.addPoints(Long.valueOf(Long.parseLong(memberId)), Integer.valueOf(-needPoints.intValue()), Integer.valueOf(1), "\u5151\u6362\u5546\u54c1\u8ba2\u5355\u53f7:" + orderInfo.getOrderNo());
        }
        return AjaxResult.success((Object)orderInfo);
    }
    ...
    public AjaxResult removeById(@PathVariable String id) {
        ...
        if (orderInfo == null) {
            return AjaxResult.error((int)MyReturnCode.ERR_70005.getCode(), (String)MyReturnCode.ERR_70005.getMsg());
        }
        if (!OrderInfoEnum.STATUS_5.getValue().equals(orderInfo.getStatus()) || "1".equals(orderInfo.getIsPay())) {
            return AjaxResult.error((int)MyReturnCode.ERR_70001.getCode(), (String)MyReturnCode.ERR_70001.getMsg());
        }
        return AjaxResult.success((Object)this.orderInfoService.removeById((Serializable)((Object)id)));
    }
    ...
    public AjaxResult unifiedOrder(HttpServletRequest request, @RequestBody OrderInfo orderInfo) throws WxPayException {
        ...
        if (memberId == null || memberId.isEmpty()) {
            return AjaxResult.error((int)MyReturnCode.ERR_70001.getCode(), (String)"\u8bf7\u5148\u767b\u5f55");
        }
        ...
        if (!"0".equals(orderInfo.getIsPay())) {
            return AjaxResult.error((int)MyReturnCode.ERR_70004.getCode(), (String)MyReturnCode.ERR_70004.getMsg());
        }
        ...
        if ("4".equals(orderInfo.getPaymentWay())) {
            ...
            this.integralFlowService.addPoints(Long.valueOf(Long.parseLong(memberId)), Integer.valueOf(-orderInfo.getPaymentPrice().intValue()), Integer.valueOf(9), "\u79ef\u5206\u8d2d\u4e70\u5546\u54c1-" + orderInfo.getName());
            orderInfo.setPaymentTime(LocalDateTime.now());
            this.orderInfoService.notifyOrder(orderInfo);
            return AjaxResult.success();
        }
        String appId = WxMaUtil.getAppId((HttpServletRequest)request);
        ...
        return AjaxResult.success((Object)JSONUtil.parse((Object)wxPayService.createOrder(wxPayUnifiedOrderRequest)));
    }
    ...
    public String notifyOrder(@RequestBody String xmlData) throws WxPayException {
        ...
        OrderInfo orderInfo = (OrderInfo)this.orderInfoService.getOne((Wrapper)Wrappers.lambdaQuery().eq(OrderInfo::getOrderNo, (Object)notifyResult.getOutTradeNo()));
        if (orderInfo != null) {
            if (orderInfo.getPaymentPrice().multiply(new BigDecimal(100)).intValue() == notifyResult.getTotalFee().intValue()) {
                String timeEnd = notifyResult.getTimeEnd();
                LocalDateTime paymentTime = LocalDateTimeUtils.parse((String)timeEnd);
            ...
            return WxPayNotifyResponse.fail((String)"\u4ed8\u6b3e\u91d1\u989d\u4e0e\u8ba2\u5355\u91d1\u989d\u4e0d\u7b49");
        }
        return WxPayNotifyResponse.fail((String)"\u65e0\u6b64\u8ba2\u5355");
    }
    ...
    public String notifyLogisticsr(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            JSONObject jsonObject = JSONUtil.parseObj((String)param);
            map.put("result", true);
            ...
            try {
                ...
                log.error("\u7269\u6d41\u56de\u8c03\u5199\u54cd\u5e94\u5931\u8d25", (Throwable)e1);
            }
        }
        return null;
    }
    ...
    public AjaxResult count(OrderInfo orderInfo) {
        ...
        countAll.put(OrderInfoEnum.STATUS_0.getValue(), this.orderInfoService.count((Wrapper)((LambdaQueryWrapper)Wrappers.query((Object)orderInfo).lambda().isNull(OrderInfo::getStatus)).eq(OrderInfo::getIsPay, (Object)"0")));
        countAll.put(OrderInfoEnum.STATUS_1.getValue(), this.orderInfoService.count((Wrapper)((LambdaQueryWrapper)Wrappers.query((Object)orderInfo).lambda().eq(OrderInfo::getStatus, (Object)OrderInfoEnum.STATUS_1.getValue())).eq(OrderInfo::getIsPay, (Object)"1")));
        countAll.put(OrderInfoEnum.STATUS_2.getValue(), this.orderInfoService.count((Wrapper)((LambdaQueryWrapper)Wrappers.query((Object)orderInfo).lambda().eq(OrderInfo::getStatus, (Object)OrderInfoEnum.STATUS_2.getValue())).eq(OrderInfo::getIsPay, (Object)"1")));
        countAll.put(OrderInfoEnum.STATUS_3.getValue(), this.orderInfoService.count((Wrapper)((LambdaQueryWrapper)Wrappers.query((Object)orderInfo).lambda().eq(OrderInfo::getStatus, (Object)OrderInfoEnum.STATUS_3.getValue())).eq(OrderInfo::getIsPay, (Object)"1")));
    ...
    public String notifyRefunds(@RequestBody String xmlData) {
        ...
        try {
            ...
            log.error("\u9000\u6b3e\u56de\u8c03\u5904\u7406\u5f02\u5e38", (Throwable)e);
            return WxPayNotifyResponse.fail((String)"\u5904\u7406\u5931\u8d25");
        }
    }
