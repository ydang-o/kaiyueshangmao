 ...
 *  com.dingyangmall.mall.constant.MallReturnCode
 *  com.dingyangmall.mall.dto.AppRegisterBody
 *  com.dingyangmall.mall.dto.IntegralPacketDTO
...
public class AppMemberApi {
    ...
    public AjaxResult sendSmsCode(@RequestParam String phone) {
        if (StringUtils.isBlank((CharSequence)phone)) {
            return AjaxResult.error((String)"\u624b\u673a\u53f7\u4e0d\u80fd\u4e3a\u7a7a");
        }
        if (phone.length() != 11) {
            return AjaxResult.error((String)"\u624b\u673a\u53f7\u683c\u5f0f\u4e0d\u6b63\u786e");
        }
        this.smsService.sendSmsCode(phone);
        return AjaxResult.success((String)"\u9a8c\u8bc1\u7801\u5df2\u53d1\u9001");
    }
    ...
    public AjaxResult getMemberInfo() {
        ...
        try {
            ...
            return AjaxResult.success((Object)member);
        }
    ...
    public AjaxResult signIn() {
        ...
        try {
            ...
            return AjaxResult.error((String)"\u4eca\u65e5\u5df2\u7b7e\u5230\u6216\u6682\u65e0\u7b7e\u5230\u6d3b\u52a8");
        }
        catch (NumberFormatException e) {
            return AjaxResult.error((String)"\u65e0\u6548\u7684\u7528\u6237ID");
        }
    ...
    public AjaxResult login(@RequestBody AppRegisterBody loginBody) {
        ...
        if (StringUtils.isAnyBlank((CharSequence[])new CharSequence[]{phone, password})) {
            return AjaxResult.error((String)"\u624b\u673a\u53f7\u548c\u5bc6\u7801\u4e0d\u80fd\u4e3a\u7a7a");
        }
        UmsMember member = (UmsMember)this.umsMemberService.getOne((Wrapper)Wrappers.lambdaQuery().eq(UmsMember::getPhone, (Object)phone));
        if (member == null) {
            SysUser dealerUser = this.getDealerSysUserByPhone(phone);
            if (dealerUser == null) {
                return AjaxResult.error((String)MallReturnCode.ERR_70003.getCode(), (Object)MallReturnCode.ERR_70003.getMsg());
            }
            if (!this.bCryptPasswordEncoder.matches((CharSequence)password, dealerUser.getPassword())) {
                return AjaxResult.error((String)MallReturnCode.ERR_70007.getCode(), (Object)MallReturnCode.ERR_70007.getMsg());
            }
            member = this.ensureUmsMemberForDealerPhone(phone, dealerUser);
        } else if (!this.bCryptPasswordEncoder.matches((CharSequence)password, member.getPassword())) {
            return AjaxResult.error((String)MallReturnCode.ERR_70007.getCode(), (Object)MallReturnCode.ERR_70007.getMsg());
        }
    ...
    public AjaxResult loginBySms(@RequestBody Map<String, String> body) {
        ...
        if (StringUtils.isAnyBlank((CharSequence[])new CharSequence[]{phone, code})) {
            return AjaxResult.error((String)"\u624b\u673a\u53f7\u548c\u9a8c\u8bc1\u7801\u4e0d\u80fd\u4e3a\u7a7a");
        }
        if (phone.length() != 11) {
            return AjaxResult.error((String)"\u624b\u673a\u53f7\u683c\u5f0f\u4e0d\u6b63\u786e");
        }
        ...
        if (member == null) {
            SysUser dealerUser = this.getDealerSysUserByPhone(phone);
            if (dealerUser == null) {
                return AjaxResult.error((String)"\u8be5\u624b\u673a\u53f7\u672a\u6ce8\u518c\uff0c\u8bf7\u5148\u6ce8\u518c");
            }
            member = this.ensureUmsMemberForDealerPhone(phone, dealerUser);
        }
        return this.buildLoginResult(member);
    ...
    public AjaxResult registerBySms(@RequestBody Map<String, String> body) {
        ...
        this.smsService.validateSmsCode(phone, code);
        UmsMember existMember = (UmsMember)this.umsMemberService.getOne((Wrapper)Wrappers.lambdaQuery().eq(UmsMember::getPhone, (Object)phone));
        if (existMember != null) {
            return AjaxResult.error((String)"\u8be5\u624b\u673a\u53f7\u5df2\u6ce8\u518c\uff0c\u8bf7\u76f4\u63a5\u767b\u5f55");
        }
        ...
        member.setDelFlag("0");
        boolean success = this.umsMemberService.save((Object)member);
        if (!success) {
            return AjaxResult.error((String)"\u6ce8\u518c\u5931\u8d25");
        }
        ...
        if (StringUtils.isNotEmpty((String)inviteCode)) {
            SysUser dealer;
        ...
        return AjaxResult.success((String)"\u6ce8\u518c\u6210\u529f");
    }
    ...
    private AjaxResult buildLoginResult(UmsMember member) {
        ...
        member.setPassword(null);
        AjaxResult ajax = AjaxResult.success((Object)member);
    ...
    private UmsMember ensureUmsMemberForDealerPhone(String phone, SysUser dealerUser) {
        ...
        if (dealerUser != null && StringUtils.isNotEmpty((String)dealerUser.getPassword())) {
        ...
        newMember.setPoints(Integer.valueOf(0));
        newMember.setBalance(BigDecimal.ZERO);
        newMember.setLevel(Integer.valueOf(0));
        newMember.setDelFlag("0");
        this.umsMemberService.save((Object)newMember);
        return newMember;
    }
    ...
    public AjaxResult register(@RequestBody AppRegisterBody registerBody) {
        ...
        if (StringUtils.isAnyBlank((CharSequence[])new CharSequence[]{phone, code = registerBody.getCode(), password = registerBody.getPassword()})) {
            return AjaxResult.error((String)"\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a");
        }
        this.smsService.validateSmsCode(phone, code);
        long count = this.umsMemberService.count((Wrapper)Wrappers.lambdaQuery().eq(UmsMember::getPhone, (Object)phone));
        if (count > 0L) {
            return AjaxResult.error((String)"\u8be5\u624b\u673a\u53f7\u5df2\u6ce8\u518c");
        }
        UmsMember member = new UmsMember();
        member.setPhone(phone);
        member.setPassword(this.bCryptPasswordEncoder.encode((CharSequence)password));
        member.setNickname("\u7528\u6237" + phone.substring(phone.length() - 4));
        member.setCreateTime(LocalDateTime.now());
        member.setUpdateTime(LocalDateTime.now());
        member.setPoints(Integer.valueOf(0));
        ...
        if (success) {
            UmsMember inviter;
            this.integralRuleService.distributeRegisterPoints(member.getId());
            if (StringUtils.isNotEmpty((String)registerBody.getInviteCode()) && (inviter = this.umsMemberService.getByMemberCode(registerBody.getInviteCode())) != null) {
                this.integralRuleService.distributeInvitePoints(member.getId(), inviter.getId());
            }
            return AjaxResult.success((String)"\u6ce8\u518c\u6210\u529f");
        }
    ...
    public AjaxResult sendPacket(@RequestBody IntegralPacketDTO packetDTO) {
        ...
        if (StringUtils.isBlank((CharSequence)packetDTO.getPhone()) || packetDTO.getAmount() == null || packetDTO.getAmount() <= 0) {
            return AjaxResult.error((String)"\u53c2\u6570\u9519\u8bef");
        }
        if (StringUtils.isBlank((CharSequence)packetDTO.getCode())) {
            return AjaxResult.error((String)"\u9a8c\u8bc1\u7801\u4e0d\u80fd\u4e3a\u7a7a");
        }
        UmsMember sender = (UmsMember)this.umsMemberService.getById((Serializable)senderId);
        if (sender == null) {
            return AjaxResult.error((String)"\u53d1\u9001\u65b9\u8d26\u6237\u5f02\u5e38");
        }
        ...
        if (rule == null || rule.getRedPacketSwitch() == null || rule.getRedPacketSwitch() == 0) {
            return AjaxResult.error((String)"\u79ef\u5206\u7ea2\u5305\u529f\u80fd\u672a\u5f00\u542f");
        }
        UmsMember receiver = (UmsMember)this.umsMemberService.getOne((Wrapper)Wrappers.lambdaQuery().eq(UmsMember::getPhone, (Object)packetDTO.getPhone()));
        if (receiver == null) {
            return AjaxResult.error((String)"\u63a5\u6536\u65b9\u624b\u673a\u53f7\u672a\u6ce8\u518c");
        }
        if (receiver.getId().equals(senderId)) {
            return AjaxResult.error((String)"\u4e0d\u80fd\u7ed9\u81ea\u5df1\u53d1\u9001\u7ea2\u5305");
        }
        if (sender.getPoints() < packetDTO.getAmount()) {
            return AjaxResult.error((String)"\u79ef\u5206\u4f59\u989d\u4e0d\u8db3");
        }
        this.integralFlowService.addPoints(senderId, Integer.valueOf(-packetDTO.getAmount().intValue()), Integer.valueOf(4), "\u53d1\u9001\u79ef\u5206\u7ea2\u5305\u7ed9\u7528\u6237\uff1a" + receiver.getPhone());
        this.integralFlowService.addPoints(receiver.getId(), packetDTO.getAmount(), Integer.valueOf(5), "\u6536\u5230\u7528\u6237\uff1a" + sender.getPhone() + " \u7684\u79ef\u5206\u7ea2\u5305");
        return AjaxResult.success((String)"\u7ea2\u5305\u53d1\u9001\u6210\u529f");
    }
    ...
    public AjaxResult resetPassword(@RequestBody AppRegisterBody body) {
        ...
        if (StringUtils.isAnyBlank((CharSequence[])new CharSequence[]{phone, code, password})) {
            return AjaxResult.error((String)"\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a");
        }
        this.smsService.validateSmsCode(phone, code);
        UmsMember member = (UmsMember)this.umsMemberService.getOne((Wrapper)Wrappers.lambdaQuery().eq(UmsMember::getPhone, (Object)phone));
        ...
        member.setPassword(this.bCryptPasswordEncoder.encode((CharSequence)password));
        member.setUpdateTime(LocalDateTime.now());
        this.umsMemberService.updateById((Object)member);
        return AjaxResult.success((String)"\u5bc6\u7801\u91cd\u7f6e\u6210\u529f");
    }
    ...
    public AjaxResult updatePassword(@RequestBody Map<String, String> body) {
        ...
        if (!this.bCryptPasswordEncoder.matches((CharSequence)oldPassword, member.getPassword())) {
            return AjaxResult.error((String)"\u65e7\u5bc6\u7801\u9519\u8bef");
        }
        member.setPassword(this.bCryptPasswordEncoder.encode((CharSequence)newPassword));
        member.setUpdateTime(LocalDateTime.now());
        this.umsMemberService.updateById((Object)member);
        return AjaxResult.success((String)"\u5bc6\u7801\u4fee\u6539\u6210\u529f");
    }
}
