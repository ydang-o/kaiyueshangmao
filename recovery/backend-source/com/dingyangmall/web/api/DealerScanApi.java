 ...
 *  com.dingyangmall.common.utils.crypto.AesEncryptUtils
...
public class DealerScanApi {
    ...
    public AjaxResult identifyUser(@RequestParam String memberCode) {
        ...
        if (dealerMemberId == null) {
            return AjaxResult.error((String)"\u767b\u5f55\u5df2\u8fc7\u671f\u6216\u7ecf\u9500\u5546\u8d26\u53f7\u4fe1\u606f\u5f02\u5e38\uff0c\u8bf7\u91cd\u65b0\u767b\u5f55");
        }
        ...
        try {
            ...
            if (decryptedData != null && (parts = decryptedData.split("\\|")).length >= 4) {
                ...
                if (member != null) {
                    ...
                    if (!valid) {
                        return AjaxResult.error((String)"\u52a8\u6001\u7801\u5df2\u8fc7\u671f\u6216\u65e0\u6548\uff0c\u8bf7\u5237\u65b0\u4f1a\u5458\u7801");
                    }
                    isDynamicCode = true;
                }
            }
        ...
        if (member == null) {
            return AjaxResult.error((String)"\u65e0\u6548\u7684\u4f1a\u5458\u7801");
        }
        if (!isDynamicCode) {
            return AjaxResult.error((String)"\u8bf7\u4f7f\u7528\u52a8\u6001\u4f1a\u5458\u7801\u8fdb\u884c\u626b\u63cf");
        }
        String verifyCode = this.generateVerifyCode();
        String redisKey = VERIFY_CODE_PREFIX + member.getId();
        this.redisTemplate.opsForValue().set((Object)redisKey, (Object)verifyCode, 5L, TimeUnit.MINUTES);
    ...
    public AjaxResult grantPoints(@RequestBody Map<String, Object> body) {
        ...
        String dealerName;
        String storedCode;
        log.info("[\u7ecf\u9500\u5546\u53d1\u653e] grantPoints \u88ab\u8c03\u7528, body={}", body);
        String dealerId = MemberUtils.getMemberId();
        if (StringUtils.isEmpty((String)dealerId)) {
            return AjaxResult.error((String)"\u672a\u767b\u5f55");
        }
        ...
        UmsMember member = null;
        if (StringUtils.isNotEmpty((String)memberIdStr)) {
            try {
                member = (UmsMember)this.umsMemberService.getById((Serializable)Long.valueOf(Long.parseLong(memberIdStr)));
            }
        ...
        Boolean isNew = this.redisTemplate.opsForValue().setIfAbsent((Object)idempotentKey, (Object)"1", 30L, TimeUnit.SECONDS);
        if (Boolean.FALSE.equals(isNew)) {
            return AjaxResult.error((String)"\u8be5\u7b14\u53d1\u653e\u6b63\u5728\u5904\u7406\u4e2d\uff0c\u8bf7\u52ff\u91cd\u590d\u64cd\u4f5c");
        }
        String redisKey = VERIFY_CODE_PREFIX + member.getId();
        Object codeObj = this.redisTemplate.opsForValue().get((Object)redisKey);
        String string = storedCode = codeObj != null ? codeObj.toString() : null;
        if (StringUtils.isEmpty((String)storedCode)) {
            this.redisTemplate.delete((Object)idempotentKey);
        ...
        final UmsMember dealer = (UmsMember)this.umsMemberService.getById((Serializable)dealerMemberId);
        String string2 = dealerName = dealer != null ? dealer.getNickname() : "\u7ecf\u9500\u5546";
        if (dealer != null && StringUtils.isNotEmpty((String)dealer.getPhone()) && (sysUsers = this.sysUserService.selectUserList(new SysUser(){
            {
                this.setPhonenumber(dealer.getPhone());
            }
        })) != null && !sysUsers.isEmpty()) {
            SysUser dealerUser = (SysUser)sysUsers.get(0);
            Integer dealerPoints = dealerUser.getDealerPoints();
            if (dealerPoints == null) {
                dealerPoints = 0;
            }
            if (dealerPoints < points) {
                return AjaxResult.error((String)("\u7ecf\u9500\u5546\u79ef\u5206\u4f59\u989d\u4e0d\u8db3\uff0c\u5f53\u524d\u4f59\u989d\uff1a" + dealerPoints + "\uff0c\u9700\u8981\u53d1\u653e\uff1a" + points));
            }
            dealerUser.setDealerPoints(Integer.valueOf(dealerPoints - points));
            ...
            issuerFlow.setIntegralNum(Integer.valueOf(-points.intValue()));
            issuerFlow.setOperType(Integer.valueOf(2));
            ...
            this.integralFlowService.save((Object)issuerFlow);
        }
        Object finalRemark = StringUtils.isNotEmpty((String)remark) ? remark : "\u7ecf\u9500\u5546[" + dealerName + "]\u53d1\u653e\u79ef\u5206";
        log.info("[\u7ecf\u9500\u5546\u53d1\u653e] \u9a8c\u8bc1\u901a\u8fc7, \u5f00\u59cb\u53d1\u653e\u79ef\u5206: \u4f1a\u5458ID={}, \u79ef\u5206={}, \u7ecf\u9500\u5546={}", new Object[]{member.getId(), points, dealerName});
    ...
    public AjaxResult deductPoints(@RequestBody Map<String, Object> body) {
        ...
        String verifyCode = (String)body.get("verifyCode");
        if (points == null || points <= 0) {
            return AjaxResult.error((String)"\u6263\u51cf\u79ef\u5206\u5fc5\u987b\u5927\u4e8e0");
        }
        if (StringUtils.isEmpty((String)verifyCode)) {
            return AjaxResult.error((String)"\u8bf7\u8f93\u5165\u9a8c\u8bc1\u7801");
        }
        ...
        Boolean isNew = this.redisTemplate.opsForValue().setIfAbsent((Object)idempotentKey, (Object)"1", 30L, TimeUnit.SECONDS);
        if (Boolean.FALSE.equals(isNew)) {
            return AjaxResult.error((String)"\u8be5\u7b14\u6263\u51cf\u6b63\u5728\u5904\u7406\u4e2d\uff0c\u8bf7\u52ff\u91cd\u590d\u64cd\u4f5c");
        }
        String redisKey = VERIFY_CODE_PREFIX + member.getId();
        Object codeObj = this.redisTemplate.opsForValue().get((Object)redisKey);
        String string = storedCode = codeObj != null ? codeObj.toString() : null;
        ...
        if (currentPoints < points) {
            return AjaxResult.error((String)("\u4f1a\u5458\u79ef\u5206\u4e0d\u8db3\uff0c\u5f53\u524d\u79ef\u5206\uff1a" + currentPoints));
        }
        UmsMember dealer = (UmsMember)this.umsMemberService.getById((Serializable)dealerMemberId);
        String dealerName = dealer != null ? dealer.getNickname() : "\u7ecf\u9500\u5546";
        Object deductRemark = StringUtils.isNotEmpty((String)remark) ? remark : "\u7ecf\u9500\u5546[" + dealerName + "]\u6263\u51cf\u79ef\u5206";
        String grantRemark = "\u4ece\u4f1a\u5458[" + member.getNickname() + "]\u8f6c\u5165\u79ef\u5206";
        this.integralFlowService.addPoints(member.getId(), Integer.valueOf(-points.intValue()), Integer.valueOf(6), (String)deductRemark);
        this.integralFlowService.addPoints(dealerMemberId, points, Integer.valueOf(7), grantRemark);
        HashMap<String, Object> result = new HashMap<String, Object>();
        result.put("memberId", member.getId());
        result.put("memberNickname", member.getNickname());
    ...
    public AjaxResult getMemberCoupons(@RequestParam String memberCode) {
        ...
        List coupons = this.couponInfoService.getMemberValidCoupons(member.getId());
    ...
    public AjaxResult verifyCoupon(@RequestBody Map<String, String> body) {
        ...
        if (StringUtils.isEmpty((String)couponCode)) {
            return AjaxResult.error((String)"\u5238\u7801\u4e0d\u80fd\u4e3a\u7a7a");
        }
        UmsMember dealer = (UmsMember)this.umsMemberService.getById((Serializable)dealerMemberId);
        String dealerName = dealer != null ? dealer.getNickname() : "\u7ecf\u9500\u5546";
        boolean isDynamicCode = false;
        ...
        try {
            ...
            if (decryptedData != null && (parts = decryptedData.split("\\|")).length >= 5) {
                ...
                if (coupon != null) {
                    ...
                    if (!valid) {
                        return AjaxResult.error((String)"\u52a8\u6001\u7801\u5df2\u8fc7\u671f\u6216\u65e0\u6548");
                    }
                    isDynamicCode = true;
                }
            }
        ...
        if (!isDynamicCode) {
            return AjaxResult.error((String)"\u8bf7\u4f7f\u7528\u52a8\u6001\u4e8c\u7ef4\u7801\u8fdb\u884c\u6838\u9500");
        }
        if (coupon == null) {
            return AjaxResult.error((String)"\u65e0\u6548\u7684\u5238\u7801");
        }
        ...
        if (success) {
            ...
            result.put("memberNickname", coupon.getUserId() != null ? ((UmsMember)this.umsMemberService.getById((Serializable)coupon.getUserId())).getNickname() : "");
            return AjaxResult.success(result);
        }
        return AjaxResult.error((String)"\u6838\u9500\u5931\u8d25\uff0c\u5238\u7801\u65e0\u6548\u6216\u5df2\u8fc7\u671f");
    }

    private String decryptDynamicCode(String code) {
        try {
            return AesEncryptUtils.decrypt((String)code);
        }
        catch (Exception e) {
            return null;
        }
    ...
    private AjaxResult checkDealerLevelPermission(Long dealerMemberId) {
        try {
            UmsMember dealerMember = (UmsMember)this.umsMemberService.getById((Serializable)dealerMemberId);
            if (dealerMember == null || StringUtils.isEmpty((String)dealerMember.getPhone())) {
                return AjaxResult.error((String)"\u7ecf\u9500\u5546\u8d26\u53f7\u4fe1\u606f\u5f02\u5e38");
            }
            ...
            if (sysUser == null || sysUser.getDealerLevel() == null) {
                return AjaxResult.error((String)"\u5f53\u524d\u8d26\u53f7\u65e0\u7ecf\u9500\u5546\u6743\u9650");
            }
            if (sysUser.getDealerLevel() < 1 || sysUser.getDealerLevel() > 3) {
                return AjaxResult.error((String)"\u4ec5\u7ecf\u9500\u5546\u53ef\u4f7f\u7528\u6b64\u529f\u80fd");
            }
            return null;
        }
        catch (Exception e) {
            return AjaxResult.error((String)"\u7ecf\u9500\u5546\u6743\u9650\u6821\u9a8c\u5931\u8d25");
        }
    }
}
