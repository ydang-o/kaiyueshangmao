...
extends BaseController {
    ...
    public AjaxResult getOrderInfoPage(Page page, OrderInfo orderInfo) {
        return AjaxResult.success((Object)this.orderInfoService.page1((IPage)page, (Wrapper)Wrappers.query((Object)orderInfo)));
    }

    @GetMapping(value={"/count"})
    public AjaxResult getCount(OrderInfo orderInfo) {
        return AjaxResult.success((Object)this.orderInfoService.count((Wrapper)Wrappers.query((Object)orderInfo)));
    }
    ...
    public AjaxResult save(@RequestBody OrderInfo orderInfo) {
        return AjaxResult.success((Object)this.orderInfoService.save((Object)orderInfo));
    }

    @PutMapping
    @PreAuthorize(value="@ss.hasPermi('mall:orderinfo:edit')")
    public AjaxResult updateById(@RequestBody OrderInfo orderInfo) {
        return AjaxResult.success((Object)this.orderInfoService.updateById((Object)orderInfo));
    }
    ...
    public AjaxResult orderCancel(@PathVariable String id) {
        OrderInfo orderInfo = (OrderInfo)this.orderInfoService.getById((Serializable)((Object)id));
        if (orderInfo == null) {
            return AjaxResult.error((String)MallReturnCode.ERR_70005.getCode(), (Object)MallReturnCode.ERR_70005.getMsg());
        }
        if (!"0".equals(orderInfo.getIsPay())) {
            return AjaxResult.error((String)MallReturnCode.ERR_70001.getCode(), (Object)MallReturnCode.ERR_70001.getMsg());
        }
    ...
    public AjaxResult ship(@PathVariable String id, @RequestBody Map<String, String> body) {
        ...
        if (!OrderInfoEnum.STATUS_1.getValue().equals(order.getStatus())) {
            return AjaxResult.error((String)"\u53ea\u6709\u5f85\u53d1\u8d27\u8ba2\u5355\u53ef\u6267\u884c\u53d1\u8d27");
        }
        ...
        if (logisticsCode == null || logisticsCode.isEmpty() || logisticsNo == null || logisticsNo.isEmpty()) {
            return AjaxResult.error((String)"\u8bf7\u586b\u5199\u5feb\u9012\u516c\u53f8\u548c\u5feb\u9012\u5355\u53f7");
        }
        ...
        if (logistics.getId() != null && !logistics.getId().isEmpty()) {
            this.orderLogisticsService.updateById((Object)logistics);
        } else {
            this.orderLogisticsService.save((Object)logistics);
            order.setLogisticsId(logistics.getId());
        }
        order.setStatus(OrderInfoEnum.STATUS_2.getValue());
        order.setDeliveryTime(LocalDateTime.now());
        this.orderInfoService.updateById((Object)order);
        return AjaxResult.success();
    }
