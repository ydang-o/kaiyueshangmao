 ...
 *  com.dingyangmall.common.exception.file.InvalidExtensionException
 *  com.dingyangmall.common.utils.file.FileUploadUtils
 *  com.dingyangmall.common.utils.file.MimeTypeUtils
...
extends BaseController {
    ...
    public AjaxResult getGoodsSpuPage(Page page, GoodsSpu goodsSpu) {
        IPage result = this.goodsSpuService.page1((IPage)page, goodsSpu);
    ...
    public List<GoodsSpu> getList(GoodsSpu goodsSpu) {
        return this.goodsSpuService.list((Wrapper)Wrappers.query((Object)goodsSpu).lambda().select(new SFunction[]{GoodsSpu::getId, GoodsSpu::getName}));
    }

    @GetMapping(value={"/count"})
    public AjaxResult getCount(GoodsSpu goodsSpu) {
        return AjaxResult.success((Object)this.goodsSpuService.count((Wrapper)Wrappers.query((Object)goodsSpu)));
    }
    ...
    public AjaxResult getById(@PathVariable(value="id") String id) {
        ...
        return AjaxResult.success((Object)spu);
    }
    ...
    public AjaxResult uploadImage(MultipartFile file) throws IOException, InvalidExtensionException {
        ...
        if (path == null) {
            return AjaxResult.error((String)"\u4e0a\u4f20\u8def\u5f84\u672a\u914d\u7f6e");
        }
        return AjaxResult.success((String)"\u4e0a\u4f20\u6210\u529f").put("url", (Object)path).put("fileName", (Object)path);
    }
    ...
    public AjaxResult uploadImages(@RequestParam(value="files") List<MultipartFile> files) throws IOException, InvalidExtensionException {
        if (files == null || files.isEmpty()) {
            return AjaxResult.success().put("urls", List.of());
        }
        ...
        return AjaxResult.success((String)"\u4e0a\u4f20\u6210\u529f").put("urls", urls);
    }
    ...
    private String saveGoodsImageToLocal(MultipartFile file) throws IOException, InvalidExtensionException {
        ...
        return FileUploadUtils.upload((String)baseDir, (MultipartFile)file, (String[])MimeTypeUtils.IMAGE_EXTENSION);
    }

    @PostMapping
    @PreAuthorize(value="@ss.hasPermi('mall:goodsspu:add')")
    public AjaxResult save(@RequestBody GoodsSpu goodsSpu) {
        return AjaxResult.success((Object)this.goodsSpuService.save1(goodsSpu));
    }

    @PutMapping
    @PreAuthorize(value="@ss.hasPermi('mall:goodsspu:edit')")
    public AjaxResult updateById(@RequestBody GoodsSpu goodsSpu) {
        return AjaxResult.success((Object)this.goodsSpuService.updateById1(goodsSpu));
    }
    ...
    public AjaxResult updateById(@RequestParam(value="shelf") String shelf, @RequestParam(value="ids") String ids) {
        ...
        return AjaxResult.success((Object)this.goodsSpuService.update((Object)goodsSpu, (Wrapper)Wrappers.lambdaQuery().in(GoodsSpu::getId, (Collection)Convert.toList((Object)ids))));
    }

    @DeleteMapping(value={"/{id}"})
    @PreAuthorize(value="@ss.hasPermi('mall:goodsspu:del')")
    public AjaxResult removeById(@PathVariable String id) {
        return AjaxResult.success((Object)this.goodsSpuService.removeById((Serializable)((Object)id)));
    }
