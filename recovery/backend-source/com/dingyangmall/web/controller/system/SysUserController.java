...
extends BaseController {
    ...
    public TableDataInfo list(SysUser user) {
        ...
        for (SysUser u : list) {
            ...
            if (StringUtils.isNotEmpty((String)u.getPhonenumber())) {
    ...
    public AjaxResult add(@RequestBody SysUser user) {
        ...
        if (user.getPhonenumber() != null && user.getSmsCode() != null) {
            try {
                ...
                return AjaxResult.error((String)"\u77ed\u4fe1\u9a8c\u8bc1\u7801\u9519\u8bef\u6216\u5df2\u8fc7\u671f");
            }
        }
        if (StringUtils.isEmpty((String)(rawPassword = user.getPassword()))) {
            rawPassword = DEFAULT_DEALER_PASSWORD;
        }
        user.setPassword(SecurityUtils.encryptPassword((String)rawPassword));
        if (user.getDealerLevel() != null && user.getDealerLevel() > 0 && StringUtils.isEmpty((String)user.getInviteCode())) {
            return AjaxResult.error((String)"\u9080\u8bf7\u7801\u4e0d\u80fd\u4e3a\u7a7a\uff0c\u8bf7\u624b\u52a8\u586b\u5199\u9080\u8bf7\u7801");
        }
        ...
        if (result > 0) {
            if (DEFAULT_DEALER_PASSWORD.equals(rawPassword)) {
                return AjaxResult.success((String)"\u521b\u5efa\u6210\u529f\uff0c\u521d\u59cb\u5bc6\u7801\u4e3a\uff1a123456\uff0c\u8bf7\u9996\u6b21\u767b\u5f55\u540e\u4fee\u6539\u5bc6\u7801");
            }
            return AjaxResult.success((String)"\u521b\u5efa\u6210\u529f");
        }
        return AjaxResult.error((String)"\u521b\u5efa\u5931\u8d25");
    }
    ...
    public AjaxResult edit(@RequestBody SysUser user) {
        ...
        if (result > 0) {
            return AjaxResult.success((String)"\u4fee\u6539\u6210\u529f");
        }
        return AjaxResult.error((String)"\u4fee\u6539\u5931\u8d25");
    }
    ...
    public AjaxResult remove(@PathVariable Long userId) {
        ...
        if (currentUserId.equals(userId)) {
            return AjaxResult.error((String)"\u4e0d\u80fd\u5220\u9664\u5f53\u524d\u767b\u5f55\u7528\u6237");
        }
        if (currentUser.getDealerLevel() != null && currentUser.getDealerLevel() == 2) {
            return AjaxResult.error((String)"\u60a8\u6ca1\u6709\u6743\u9650\u5220\u9664\u7ecf\u9500\u5546");
        }
        if (currentUser.getDealerLevel() != null && currentUser.getDealerLevel() == 1) {
            ...
            if (targetUser.getDealerLevel() == null || targetUser.getDealerLevel() != 2) {
                return AjaxResult.error((String)"\u60a8\u53ea\u80fd\u5220\u9664\u4e8c\u7ea7\u7ecf\u9500\u5546");
            }
            if (!currentUserId.equals(targetUser.getParentDistributorId())) {
                return AjaxResult.error((String)"\u60a8\u53ea\u80fd\u5220\u9664\u81ea\u5df1\u521b\u5efa\u7684\u4e8c\u7ea7\u7ecf\u9500\u5546");
            }
        }
        if ((result = this.userService.deleteUserById(userId)) > 0) {
            return AjaxResult.success((String)"\u5220\u9664\u6210\u529f");
        }
        return AjaxResult.error((String)"\u5220\u9664\u5931\u8d25");
    }
    ...
    public AjaxResult sendSmsCode(@RequestParam String phone) {
        ...
        return AjaxResult.success((String)"\u9a8c\u8bc1\u7801\u53d1\u9001\u6210\u529f");
    }
