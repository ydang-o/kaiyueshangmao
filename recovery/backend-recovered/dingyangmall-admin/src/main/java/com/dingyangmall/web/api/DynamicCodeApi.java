...
public class DynamicCodeApi {
    ...
    public AjaxResult getDynamicMemberCode() {
        ...
        try {
            ...
            if (StringUtils.isEmpty(phoneNumber)) {
                return AjaxResult.error("\u7528\u6237\u672a\u7ed1\u5b9a\u624b\u673a\u53f7");
            }
    ...
    public AjaxResult getDynamicCouponCode(@PathVariable Long couponId) {
        ...
        try {
            ...
            TbCouponInfo coupon = (TbCouponInfo)this.couponInfoService.getById(couponId);
            if (coupon == null) {
                return AjaxResult.error("\u4f18\u60e0\u5238\u4e0d\u5b58\u5728");
            }
            if (!coupon.getUserId().equals(userId)) {
                return AjaxResult.error("\u65e0\u6743\u8bbf\u95ee\u6b64\u4f18\u60e0\u5238");
            }
    ...
    public AjaxResult getDynamicCouponCodes() {
        ...
        try {
            ...
            List<TbCouponInfo> coupons = this.couponInfoService.getUserCoupons(userId, 1);
