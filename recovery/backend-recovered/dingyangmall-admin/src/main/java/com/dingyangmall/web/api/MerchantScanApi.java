...
public class MerchantScanApi {
    ...
    public AjaxResult givePoints(@RequestBody Map<String, Object> body) {
        ...
        if (dealer != null && !dealer.isAdmin()) {
            List dealerMemberList = this.umsMemberService.list((Wrapper)Wrappers.lambdaQuery().eq(UmsMember::getPhone, dealer.getPhonenumber()));
            if (dealerMemberList.isEmpty()) {
                return AjaxResult.error("\u5f53\u524d\u5546\u5bb6\u672a\u7ed1\u5b9a\u4f1a\u5458\uff0c\u8bf7\u8054\u7cfb\u7ba1\u7406\u5458");
            }
            ...
            this.integralFlowService.addPoints(dealerMember.getId(), -points.intValue(), 2, "\u626b\u7801\u8d60\u9001\u79ef\u5206\u7ed9\u4f1a\u5458[" + member.getNickname() + "]");
        }
        log.info("[\u5546\u5bb6\u8d60\u9001\u79ef\u5206] \u5f00\u59cb: \u5546\u5bb6={}, \u4f1a\u5458ID={}, \u79ef\u5206={}", dealer != null ? dealer.getNickName() : "\u672a\u77e5", member.getId(), points);
        this.integralFlowService.addPoints(member.getId(), points, 2, remark);
