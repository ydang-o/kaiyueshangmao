...
var _imageUrl = __webpack_require__(/*! ./utils/imageUrl */ 37);
...
/***/ 27:
/*!******************************************************************************!*\
  !*** D:/work_boss/kaiyueshangmao/dingyangmall-wx/dingyangmall-wx-ma/App.vue ***!
  \******************************************************************************/
/*! no static exports found */
...
/***/ 28:
/*!*******************************************************************************************************!*\
  !*** D:/work_boss/kaiyueshangmao/dingyangmall-wx/dingyangmall-wx-ma/App.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _default = {
  ...
  methods: {
    ...
    shoppingCartCount: function shoppingCartCount() {
      ...
      if (!hasToken) {
        if (_util.default && _util.default.updateCartBadge) _util.default.updateCartBadge(0);
        return;
      }
      ...
      apiRef.shoppingCartCount().then(function (res) {
        var count = res.data != null ? res.data : res;
        if (_util.default && _util.default.updateCartBadge) _util.default.updateCartBadge(count);
      }).catch(function () {
        if (_util.default && _util.default.updateCartBadge) _util.default.updateCartBadge(0);
      });
    },
