...
/* harmony import */ var _index_vue_vue_type_style_index_0_id_71e217db_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=71e217db&scoped=true&lang=css& */ 39);
...
var GoodsCardIndex = function GoodsCardIndex() {
  __webpack_require__.e(/*! require.ensure | components/goods-card-index/index */ "components/goods-card-index/index").then((function () {
    return resolve(__webpack_require__(/*! @/components/goods-card-index/index.vue */ 86));
...
var _default = {
  ...
  data: function data() {
    ...
    return {
      ...
      goodsList: [],
      goodsListHot: [],
      swiperData: ['https://dingyangmall-base-test.oss-cn-zhangjiakou.aliyuncs.com/1/material/c888e1d3-f542-4b4e-aa43-be9d50cc0696.jpg', 'https://dingyangmall-base-test.oss-cn-zhangjiakou.aliyuncs.com/1/material/a5e3b9f4-f1fe-4bb2-b487-13f4395ef187.jpg', 'https://dingyangmall-base-test.oss-cn-zhangjiakou.aliyuncs.com/1/material/c8fd87ff-ca5d-4f95-8f81-e99cae48b0f7.jpg', 'https://dingyangmall-base-test.oss-cn-zhangjiakou.aliyuncs.com/1/material/bf176bd5-3487-4b61-8d30-1cc2ad95b8ac.jpg'],
      navList: [{
        url: '/pages/goods/goods-detail/index?id=1442505794278191105',
        img: '/static/img/6-1.png',
        text: 'iPhone'
      }, {
        url: '/pages/goods/goods-detail/index?id=1442512382615416833',
        img: '/static/img/6-2.png',
        text: 'iPad'
      }, {
        url: '/pages/goods/goods-detail/index?id=1442512958581436418',
        img: '/static/img/6-3.png',
        text: 'Mac'
      }, {
        url: '/pages/goods/goods-detail/index?id=1442513594978988034',
        img: '/static/img/6-4.png',
        text: 'Watch'
      }, {
        url: '/pages/goods/goods-detail/index?id=1442514202062548994',
        img: '/static/img/6-5.png',
        text: 'AirPods'
      }]
    };
  },
  ...
  methods: {
    ...
    loadData: function loadData() {
      ...
      Promise.all([app.api.goodsPage({
        ...
        size: 5,
        descs: 'sale_num'
      }), app.api.goodsPage(this.page)]).then(function (_ref) {
    ...
    goodsPage: function goodsPage() {
      ...
      getApp().api.goodsPage(this.page).then(function (res) {
        ...
        _this3.goodsList = [].concat((0, _toConsumableArray2.default)(_this3.goodsList), (0, _toConsumableArray2.default)(list));
        if (list.length < _this3.page.size) _this3.loadmore = false;
      }).catch(function () {});
    },
