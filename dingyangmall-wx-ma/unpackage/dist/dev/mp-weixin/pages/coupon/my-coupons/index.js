...
/***/ 151:
/*!*****************************************************************************************************************************!*\
  !*** D:/work_boss/kaiyueshangmao/dingyangmall-wx/dingyangmall-wx-ma/main.js?{"page":"pages%2Fcoupon%2Fmy-coupons%2Findex"} ***!
  \*****************************************************************************************************************************/
...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/coupon/my-coupons/index.vue */ 152));
// @ts-ignore
...
/***/ 152:
/*!********************************************************************************************************!*\
  !*** D:/work_boss/kaiyueshangmao/dingyangmall-wx/dingyangmall-wx-ma/pages/coupon/my-coupons/index.vue ***!
  \********************************************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _index_vue_vue_type_template_id_5eb6174f_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=5eb6174f&scoped=true& */ 153);
...
/* harmony import */ var _index_vue_vue_type_style_index_0_id_5eb6174f_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=5eb6174f&scoped=true&lang=css& */ 157);
...
/***/ 153:
/*!***************************************************************************************************************************************************!*\
  !*** D:/work_boss/kaiyueshangmao/dingyangmall-wx/dingyangmall-wx-ma/pages/coupon/my-coupons/index.vue?vue&type=template&id=5eb6174f&scoped=true& ***!
  \***************************************************************************************************************************************************/
...
var render = function () {
  ...
  var l0 = _vm.__map(_vm.coupons, function (item, i) {
    var $orig = _vm.__get_orig(item)
    var m0 = item.couponCode ? _vm.qrUrl(item.couponCode) : null
    return {
      $orig: $orig,
      m0: m0,
    }
...
/***/ 155:
/*!*********************************************************************************************************************************!*\
  !*** D:/work_boss/kaiyueshangmao/dingyangmall-wx/dingyangmall-wx-ma/pages/coupon/my-coupons/index.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 156:
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/work_boss/kaiyueshangmao/dingyangmall-wx/dingyangmall-wx-ma/pages/coupon/my-coupons/index.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  onLoad: function onLoad() {
    ...
    _util.default.requireLogin('请先登录后查看优惠券').then(function (ok) {
      if (!ok) return;
      var init = typeof getApp === 'function' && getApp() && getApp().initPage;
  ...
  methods: {
    ...
    getApi: function getApi() {
      ...
      return app && app.api || _api.default;
    },
    getCoupons: function getCoupons() {
      var _this2 = this;
      var api = this.getApi();
      var fn = api && api.couponMyMa && typeof api.couponMyMa === 'function' ? api.couponMyMa : api && api.couponMy;
      if (!fn) {
        this.coupons = [];
        return;
      }
      fn.call(api, this.status).then(function (res) {
        var ok = res && (res.code === 0 || res.code === 200 || res.code === '200' || res.code === '0');
        _this2.coupons = ok ? _this2._parseCouponList(res) : [];
      }).catch(function () {
        _this2.coupons = [];
      });
    },
    _parseCouponList: function _parseCouponList(res) {
      var data = res && (res.data !== undefined ? res.data : res);
      var list = [];
      if (Array.isArray(data)) list = data;else if (data && Array.isArray(data.records)) list = data.records;else if (data && Array.isArray(data.list)) list = data.list;else if (data && Array.isArray(data.rows)) list = data.rows;else if (data && Array.isArray(data.content)) list = data.content;
    ...
    qrUrl: function qrUrl(couponCode) {
...
/***/ 157:
/*!*****************************************************************************************************************************************************************!*\
  !*** D:/work_boss/kaiyueshangmao/dingyangmall-wx/dingyangmall-wx-ma/pages/coupon/my-coupons/index.vue?vue&type=style&index=0&id=5eb6174f&scoped=true&lang=css& ***!
  \*****************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
